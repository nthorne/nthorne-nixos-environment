...
pushd ${HOME}/repos
test -d nthorne-tmux-environment   || git clone https://github.com/nthorne-tmux-environment
test -d nthorne-vim-environment    || git clone https://github.com/nthorne-vim-environment
test -d nthorne-xmonad-environment || git clone https://github.com/nthorne-xmonad-environment
test -d nthorne-zsh-environment    || git clone https://github.com/nthorne-zsh-environment
popd

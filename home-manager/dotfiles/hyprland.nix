{pkgs, lib,...}: {
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      hl.bind(mainMod .. " + SHIFT + w", hl.dsp.workspace.move({ monitor = 2 }))
      hl.bind(mainMod .. " + SHIFT + e", hl.dsp.workspace.move({ monitor = 1 }))
      hl.bind(mainMod .. " + SHIFT + r", hl.dsp.workspace.move({ monitor = 0 }))
